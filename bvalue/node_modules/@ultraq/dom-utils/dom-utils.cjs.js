...
function parseJsonFromElement(selector) {
  var _scope$querySelector, _scope$querySelector$;

  var scope = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document;
  return JSON.parse(((_scope$querySelector = scope.querySelector(selector)) === null || _scope$querySelector === void 0 ? void 0 : (_scope$querySelector$ = _scope$querySelector.textContent) === null || _scope$querySelector$ === void 0 ? void 0 : _scope$querySelector$.trim()) || null);
}
/**
